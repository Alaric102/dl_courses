    ...
    def fit(self, is_verbose = True):
        ...
        for epoch in range(self.num_epochs):
            ...
            for batch_indices in batches_indices:
                ...
                # the params
                batch_train_X = self.dataset.train_X[batch_indices]
                batch_train_y = self.dataset.train_y[batch_indices]
                loss = self.model.compute_loss_and_gradients(batch_train_X, batch_train_y)
